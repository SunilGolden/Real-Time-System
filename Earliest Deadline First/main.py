...
for i in range (n):
    ...
    print("Enter the Execution time of task:", i+1)
    tasks[i].append(int(input()))
    
    print("Enter the Periodicity time of task:", i+1)
    tasks[i].append(int(input()))
    
    print("Enter the Deadline time of task:", i+1)
    tasks[i].append(int(input()))
    
    print("Enter the Arrival time of task:", i+1)
    tasks[i].append(int(input()))
